...
const COPY = {
  ...
  headingEm: 'perdida dentro da própria vida.',
  preText: 'Eu gravei esse vídeo porque quero que você entenda uma coisa: o que você sente não é frescura. É um chamado. E eu posso te ajudar a ouvir o que ele está dizendo.',
  postText: 'Meu trabalho começa onde os conselhos de todo mundo terminam.',
}
// ════════════════════════════════════════════════════════════════════
