...
const COPY = {
  callout: 'MULHERES 30+',
  h1: 'Você tem tudo o que queria. Mas por dentro,',
  h1Em: 'se sente vazia.',
  subtitle: 'Se você está cansada de fingir que está tudo bem, essa conversa é para você.',
  ctaPrimary: 'Quero agendar minha conversa',
  ctaSecondary: 'ou conheça meu trabalho',
}
// ════════════════════════════════════════════════════════════════════
